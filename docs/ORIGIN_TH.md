...
และ contract ของมัน อ่านต่อได้ที่ [`RITUALS_TH.md`](RITUALS_TH.md)
...
- [`RITUALS_TH.md`](RITUALS_TH.md) — รายละเอียด ritual ทั้ง 7 ตัว
- [`ORIGIN.md`](ORIGIN.md) — English version
