---
title: "Contributing to Trinity OS (English)"
audience: Contributors, developers, reviewers
language: English
last-updated: 2026-04-28
note: "Translation of ../CONTRIBUTING.md"
---

# Contributing to Trinity OS (English)
...
5. Write a structured retro for every change
...
- Open an issue first (discuss intent)
- Reference the spec section being changed
- Update CHANGELOG.md
...
### Q: Do I need a vendor AI to contribute?
...
For substantial contributions, you may be asked to sign a Contributor License Agreement (CLA) if/when the project switches to Apache-2.0.
