---
title: "Trinity OS Deploy & Operations Guide (English)"
...
note: "Translation of ../09_DEPLOY_GUIDE.md"
---

# Trinity OS — Deploy & Operations Guide (English)

> Practical runbook for installing, migrating, operating and troubleshooting Trinity OS.

---

## 0. Status

- **Audience:** people who will install/migrate/operate Trinity OS
- **Prerequisite:** Read [`00_BLUEPRINT.md`](00_BLUEPRINT.md) first
...
> See [`10_UPSTREAM_AUDIT.md`](10_UPSTREAM_AUDIT.md) for project-specific gap analysis.
...
**Symptom:** Type `lll` and AI doesn't understand.

**Cause:** `CLAUDE.md` (or `AGENTS.md`/`GEMINI.md`) is missing or has no inline short codes.
