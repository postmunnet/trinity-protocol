---
title: "memory-cli Specification v1.0 (English)"
subtitle: "Knowledge Brain recall organ — FTS5 first, vector later"
language: English
version: 1.0.0-draft
status: draft
last-updated: 2026-04-28
phase: 2
note: "Translation of ../05_MEMORY_CLI_SPEC.md"
implements: TOOL_CONTRACT v1.1
---

# memory-cli Specification v1.0 (English)

> **memory-cli = Knowledge Brain recall organ.**
>
> Index 240+ retros + 14 lessons → semantic recall via CLI.
...
Current Trinity `rrr` writes a deterministic retro artifact and delegates
ingestion with `index <canonical retro path>`; `rrr` must not call `learn`
directly.
