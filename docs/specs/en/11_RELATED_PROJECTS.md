---
title: "Related Projects, Inspirations & Attributions (English)"
subtitle: "Where Trinity OS came from · what we learned from · what we don't use (and why)"
language: English
version: 1.0.0
status: reference
last-updated: 2026-04-28
note: "Translation of ../11_RELATED_PROJECTS.md"
---

# Related Projects, Inspirations & Attributions (English)

> **This document records every project that influenced Trinity OS** — inspirations, dependencies, alternatives considered, licenses, attribution.
>
> If other specs reference external projects → look here for context.
...
**Migration:** see [`10_UPSTREAM_AUDIT.md`](10_UPSTREAM_AUDIT.md)
...
**License note:** BUSL-1.1 has commercial restriction (4 years) — Trinity's memory-cli is an independent implementation, not derivative.

---

## 3. Reference Implementations (External — Studied)

At `TRINITY_LEGACY/references/github_example/`:
...
**Key learning:** Building a full harness requires multi-provider abstraction — too much scope for v0.1, hence the Trinity Shim approach.
...
**Influence:** Foundational insight — Trinity OS is positioned as 100% deterministic harness leveraging vendor AI for reasoning.
...
*Mentioned in this doc (`11_RELATED_PROJECTS.md`) for the first time.
