...
# retro-cli Specification v1.0

> **retro-cli = Structured Memory Writer**
>
> บังคับให้ retro มี schema ที่ search ได้ + auto-index เข้า memory-cli
> Additive — ของเก่าใช้ได้, ของใหม่บังคับ schema
...
- Search ค้นเจอ แต่คุณภาพไม่สม่ำเสมอ
- Evidence link ไม่ structured

### Solution
- **Additive frontmatter schema** — ของเก่าไม่พัง
...
If high-similarity match exists → ask human:
- Supersede old?
- Add as parallel?
- Merge?
...
| AI fakes evidence | File must exist + sha256 verify |
