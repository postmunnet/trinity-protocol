---
title: "Trinity OS — License Decision"
...
# Trinity OS — License Decision

> Analysis & recommendation สำหรับ Trinity OS v2 spec pack + future implementation
...
✅ Trinity ปัจจุบันใช้ **MIT License** อยู่แล้ว — decision นี้คือว่าจะ **เก็บ MIT** หรือ **upgrade เป็น Apache-2.0**
